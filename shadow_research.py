...
def build_shadow_candidate(
    *,
    ...
    score_v3_reason: str = "",
    score_v3b: Any = 0.0,
    score_v3b_version: str = "",
    score_v3b_tags: Any = "",
    score_v3b_reason: str = "",
    score_v3c: Any = 0.0,
    score_v3c_version: str = "",
    score_v3c_tags: Any = "",
    score_v3c_reason: str = "",
    ...
    return {
        ...
        "score_v3b": round(_safe_float(score_v3b), 6),
        "score_v3b_version": score_v3b_version,
        "score_v3b_tags": _clean(score_v3b_tags),
        "score_v3b_reason": score_v3b_reason,
        "score_v3c": round(_safe_float(score_v3c), 6),
        "score_v3c_version": score_v3c_version,
        "score_v3c_tags": _clean(score_v3c_tags),
        "score_v3c_reason": score_v3c_reason,
