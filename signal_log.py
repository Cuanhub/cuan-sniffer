...
def append_signal(
    ...
    try:
        ...
        append_smc_live_event(
            ...
            session=session,
            setup_family=meta.get("setup_family", regime_local),
            regime=signal.regime,
            regime_local=regime_local,
            regime_htf_1h=regime_htf_1h,
            regime_macro_4h=regime_macro_4h,
            vol_state=vol_state,
            vol_ratio=vol_ratio,
            ...
            long_short_bias=float(long_short_bias),
            order_submitted=result == "traded",
            fill_price=round(fill_price, 8),
            slippage_bps=round(fill_slippage_bps, 2),
            fill_slippage_bps=round(fill_slippage_bps, 2),
