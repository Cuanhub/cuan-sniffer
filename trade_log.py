...
HEADER = [
    ...
    "approved_max_risk_usd", "actual_risk_usd",
    "risk_authority_status", "risk_authority_reason",
    "size_multiplier",
...
def append_trade(position: Position, paper_mode: bool = False):
    ...
    row = {
        ...
        "approved_max_risk_usd": round(position.approved_max_risk_usd, 8),
        "actual_risk_usd": round(position.actual_risk_usd, 8),
        "risk_authority_status": position.risk_authority_status,
        "risk_authority_reason": position.risk_authority_reason,
